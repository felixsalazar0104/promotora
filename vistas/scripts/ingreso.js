...
function init(){
	...
	$.post("../ajax/ingreso.php?op=selectProveedor", function(r){
	            $("#consecutivo").html(r);
	            $('#consecutivo').selectpicker('refresh');
	});
...
function mostrar(idingreso)
{
	$.post("../ajax/ingreso.php?op=mostrar",{idingreso : idingreso}, function(data, status)
	{
		...
		$("#solicitud_moviles").val(data.solicitud_moviles);
...
function agregarDetalle(idarticulo,articulo)
  ...
  function eliminarDetalle(indice){
	...
	bootbox.confirm("¿Está Seguro de eliminar al funcionario?", function(result){
		if(result)
        {
			$("#fila" + indice).remove();
			calcularTotales();
  ...
  function eliminar(iddetalle_ingreso)
{
	bootbox.confirm("¿Está Seguro de eliminar al funcionario?", function(result){
		if(result)
        {
        	$.post("../ajax/ingreso.php?op=eliminar", {iddetalle_ingreso : iddetalle_ingreso}, function(e){
        		bootbox.alert(e);
	            tabla.ajax.reload();
        	});	
        }
