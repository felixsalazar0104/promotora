    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>PROMOTORA_</b></span>
        </a>
...
if ($_SESSION['almacen']==1)
{
  ...
  <ul class="treeview-menu">
    <li id="lConsulta"><a href="contratista.php"><i class="fa fa-circle-o"></i> Contratistas</a></li>
    <li id="lIngresos"><a href="personal.php"><i class="fa fa-circle-o"></i> Personal</a></li>
    <li id="lConsulta"><a href="contratista.php"><i class="fa fa-circle-o"></i> Parafiscales</a></li>
  </ul>
</li>';
}?>
...
<?php 
            if ($_SESSION['almacen']==1)
            {
              ...
              <ul class="treeview-menu">
                <li id="lIngresos"><a href="articulo.php"><i class="fa fa-circle-o"></i> Ingresos</a></li>
                <li id="lConsulta"><a href="categoria.php"><i class="fa fa-circle-o"></i> Consultas</a></li>
              </ul>
            </li>';
            }
            ?>
