                    ...
                    <div class="panel-body" style="height: 100%;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            ...
                            <input type="text" class="form-control" name="consecutivo" id="consecutivo" required="">
                          </div>
                          <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <label>Personal de Moviles Requeridas:</label>
                            <input type="text" class="form-control" name="solicitud_moviles" id="solicitud_moviles" required="" readonly>
                          </div>
                          <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <label>Personal de Moviles Contratadas:</label>
                            <input type="text" class="form-control" name="total_compra" id="total_compra" required="" readonly>
                          </div>
                          <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <label>Motocicletas Requeridas:</label>
                            <input type="text" class="form-control" name="fecha_hora" id="fecha_hora" required="" readonly>
                          </div>
                          <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <label>Motocicletas Contratadas:</label>
                            <input type="text" class="form-control" name="fecha_hora" id="fecha_hora" required="" readonly>
                          </div>
